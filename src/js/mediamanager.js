window.mediamanager = function(mediamanagerId, options, callback) {
    ...
    const bindElements = () => {
        ...
        managerContent = document.querySelector(
            `#${mediamanagerId} .manager-content`
        );
        managerUploader = document.querySelector(
            `#${mediamanagerId} .manager-uploader`
        );
        managerHeader = document.querySelector(
            `#${mediamanagerId} .manager-header`
        );
    ...
    const updateMangerItems = async localFiles => {
        ...
        managerItems = document.querySelectorAll(
            `#${mediamanagerId} .manager-item`
        );
